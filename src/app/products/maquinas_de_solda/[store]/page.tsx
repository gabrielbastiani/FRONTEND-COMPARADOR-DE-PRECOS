                                                ...
                                                <div className={styles.gridContainerProduct}>
                                                    ...
                                                    <div className={styles.boxCategory}>
                                                        ...
                                                        {item?.productCategory?.length === 0 ?
                                                            <span className={styles.notFoundCategs}>Sem categorias cadastrada...</span>
                                                            :
                                                            <>
                                                                <strong className={styles.categoryStrong}>Categoria</strong>
                                                        ...
                                                        >
                                                            ...
                                                            {categorys?.[0] ? (
                                                                <option value={`${categorys[0].name},${categorys[0].id}`}>{categorys[0].name}</option>
                                                            ) : (
