                ...
                <>
                    ...
                    <main className={styles.mainContainer}>
                        ...
                        <div className={styles.grid_container}>
                            ...
                            <div className={styles.grid_item}>
                                <button
                                    onClick={() => handleOpenModal("https://www.google.com/search?sca_esv=584838229&tbm=shop&sxsrf=ACQVn09fSGfy88Oi7V-9iTrh_juDnmtJQA:1710956314816&q=maquina+de+solda&tbs=mr:1,merchagg:m10892984&sa=X&ved=0ahUKEwig__r6sIOFAxVqIbkGHQs8BywQsysIwAkoCw&biw=1592&bih=752&dpr=1", "loja-do-mecanico")} data-valor1="valor1" data-valor2="valor2"
                                >
